...
// program yüklenirken başlangıçta yüklemesini istediğimiz verileri tanımladığımız service
public class InitialDataService {

    // başlangıçta oluşturmak istediğimiz branşları bu method da tanımladık.
